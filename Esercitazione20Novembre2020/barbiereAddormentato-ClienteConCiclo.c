...
void *eseguiCliente(void *id)
{
   ...
   for (i = 0; taglio; i++) /* il cliente vuole assolutamente tagliarsi barba/capelli */
   {
        ...
        sleep(5); /* simuliamo un'attesa prima di tornare dal barbiere */
   }
...
int main (int argc, char **argv)
{
   ...
   {
        printf("Problemi con l'inizializzazione del semaforo BARBER\n");
        exit(5);
   }
   ...
   {
        printf("Problemi con l'inizializzazione del semaforo COSTUMERS\n");
        exit(6);
   }
   ...
   for (i=0; i < NUM_THREADS; i++)
   {
	...
	if (i == 0)
		...
		/* si ricorda che all'exit del main si produrra' la terminazione comunque del barbiere */
	else
   	{
