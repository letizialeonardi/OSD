...
int main (int argc, char **argv)
{
   ...
   {
   	printf("Errore: Il primo parametro non e' un numero strettamente maggiore di 0 e non e' divisibile per 2, infatti e' %d\n", NUM_THREADS);
        exit(2);
   }
   ...
   {
        printf("Problemi con l'inizializzazione del semaforo spazio_disponibile\n");
        exit(5);
   }
   ...
   {
        printf("Problemi con l'inizializzazione del semaforo messaggio_disponibile\n");
        exit(6);
   }
